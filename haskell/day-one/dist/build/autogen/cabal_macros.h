...
/* package day-one-0.0.0 */
#define VERSION_day_one "0.0.0"
#define MIN_VERSION_day_one(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "day-one-0.0.0-3ErMdQAWGrADHUIppxOpye"

#define CURRENT_PACKAGE_KEY "day-one-0.0.0-3ErMdQAWGrADHUIppxOpye"
